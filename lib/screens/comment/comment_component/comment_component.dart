...
class CommentListComponents extends StatelessWidget {

List<CommentReadDTO> list;
CommentListComponents({Key key, this.list}) : super(key: key);
...
class _CommentListComponentState extends State<CommentChildComponent> {
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
                ...
                InkWell(
                    ...
                    child: Padding(
                      ...
                      child: IconButton(
                          ...
                          color: MainColors.kMain, iconSize: 40,
              ...
              child:
                  BlocBuilder<PostCommentBloc, PostCommentState>(builder: (context, state) {
  ...
  void postComment() {
    if(contentController.text.isEmpty) {
      ...
      CommentPostDTO _dto = CommentPostDTO(authorId: 1, videoId: 1, content: _content);
      //print(_dto);
