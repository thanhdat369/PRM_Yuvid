...
class like_service {
  ...
  Future<bool> unLikeVideo(int _videoId, int _accountId) async {
    String baseUrl = "https://tiktok-prm.azurewebsites.net/api/likes?accountId=$_accountId&videoId=$_videoId";
    Map<String, String> headers = {
      'Content-Type': 'application/json; charset=UTF-8',
    };

    final response =
    await http.delete(baseUrl, headers: headers);
